export const data2 = [
  {
    ...
    price: "1250 DA", // updated price
    image: "https://i.imgur.com/CjdhieD.jpeg",
    descp: "A friendly, fully-illustrated introduction to the most important computer programming algorithms.",
    tags: ["Computer Science", "DSA"],
  },
  {
    Book: "Clean Code",
    author: "Robert C. Martin",
    price: "1550 DA", // updated price
    image: "https://i.imgur.com/7ex7fXP.jpeg",
    descp: "Even bad code can function. But if code isn’t clean, it can bring a development organization to its knees. Every year, countless hours and significant resources are lost because of poorly written code. But it doesn’t have to be that way.",
  ...
  },
  {
    ...
    descp: "Structure and Interpretation of Computer Programs has had a dramatic impact on computer science curricula over the past decade. This long-awaited revision contains changes throughout the text.",
    tags: ["Software Engineering", "Computer Science"],
  },
  {
    ...
    descp: "OpenIntro Statistics is a beginner-friendly textbook that introduces key statistical concepts like probability, data analysis, and hypothesis testing. It focuses on real-world applications and uses practical examples to enhance understanding. The book also emphasizes the use of statistical software for data analysis.",
  ...
  },
  {
    ...
    descp: "Concise and to the point — the book can be read during a week. During that week, you will learn almost everything modern machine learning has to offer. The author and other practitioners have spent years learning these concepts.",
  ...
  },
  {
    ...
    descp: "Un guide pratique qui résume les bases des mathématiques, couvrant l’algèbre, l’analyse, la géométrie, les probabilités et les statistiques. Clair et compact, il est parfait pour réviser ou comprendre rapidement les notions essentielles.",
