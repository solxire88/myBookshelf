    ...
    <>
      <Routes>
        <Route
          ...
          element={
            <Literature
              addToCartL={(e) => addToCart(e, cart)}
              cart={cart}
              deleteFromCartL={(e) => deleteFromCart(e, cart)}
            />
          }
        />
        <Route
